...
im.save(f'{environ["HOME"]}/.config/waybar/scripts/workspaces/ws{args.workspace}.png')
print(f'{environ["HOME"]}/.config/waybar/scripts/workspaces/ws{args.workspace}.png')
